...
| LOOK-B3 | Recent searches + pinned favorites (Idea 5) | `docs/index.html` | S | Deferred per user instruction. `localStorage` keys: `fvg_lookup_recent` + `fvg_lookup_pinned`. |
| LOOK-B4 | Fuzzy / "did you mean" matching (Idea 6) | `docs/index.html` | M | Deferred per user instruction. |
| LOOK-B5 | Empty-state suggestion chips (Idea 7) | `docs/index.html` | S | Deferred per user instruction. |
